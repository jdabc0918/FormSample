========================================================================
    ダイナミック リンク ライブラリ: ManagedClass プロジェクトの概要
========================================================================

この ManagedClass DLL は、AppWizard により作成されました。

このファイルには、ManagedClass アプリケーションを構成する各ファイルの内容の概要が含まれています。

ManagedClass.vcxproj
